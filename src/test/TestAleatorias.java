...
class TestAleatorias {
	...
	void test() {
		...
		System.out.println("Matriz aleatoria - Con " + orden + " nodos y " + String.format("%2.0f", prob * 100) + "% probabilidad para cada arista" );
		...
		System.out.println("Matriz aleatoria - Con " + orden + " nodos y " + String.format("%2.0f", prob * 100) + "% de adyacencia" );
